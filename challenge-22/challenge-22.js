(function(){
  ...
  */
  function sum() {
    ...
    return Array.prototype.reduce.call(arguments, (prev, current) => Number(prev) + Number(current));
  }
  ...
  */
  ...
  console.log(justNumbers('10asd9jkfhjf876as 9'));
