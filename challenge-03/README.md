...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é Tiago Palte!'
...
pessoa.apresentacao = function() {
  ...
  return `Olá, eu sou ${apr} ${this.nome} ${this.sobrenome}, tenho ${this.idade} ${qtdIdade}, ${this.altura}, meu peso é ${this.peso} e, só hoje, eu já caminhei ${this.caminhouQuantosMetros} ${qtdMetros}!`
}
